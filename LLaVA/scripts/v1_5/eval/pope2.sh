...
CUDA_VISIBLE_DEVICES=5 python -m llava.eval.model_vqa_loader \
    ...
    --question-file /data/fyuan/hallucination/LLaVA/playground/data/pope/coco_pope_adversarial.jsonl \
    --image-folder /data/fyuan/VCR_generation/data/VQA-X/val2014 \
    --answers-file /data/fyuan/hallucination/LLaVA/playground/data/pope/llava-v1.5-7b-lora-adversarial-precision-2GPU-epoch0.95-gate0.6-default0.5-2reward.jsonl \
    --temperature 0 \
    --conv-mode vicuna_v1
...
CUDA_VISIBLE_DEVICES=5 python llava/eval/eval_pope.py \
    ...
    --question-file /data/fyuan/hallucination/LLaVA/playground/data/pope/coco_pope_adversarial.jsonl \
    --result-file /data/fyuan/hallucination/LLaVA/playground/data/pope/llava-v1.5-7b-lora-adversarial-precision-2GPU-epoch0.95-gate0.6-default0.5-2reward.jsonl