...
# CUDA_VISIBLE_DEVICES=1 python chair_eval.py \
# --cap_file /data/fyuan/hallucination/LLaVA/playground/data/chair/log/llava-v1.5-13b-lora-precision-2GPU-epoch0.85-gate0.6-default0.5-2reward/ours-presicion-2GPU-e_0.85-g_0.6-d_0.5-reward_2.jsonl \
# --image_id_key image_id --caption_key caption \
# --coco_path /data/fyuan/hallucination/LLaVA/playground/data/MSCOCO/annotations \
# --save_path /data/fyuan/hallucination/LLaVA/playground/data/chair/log/llava-v1.5-13b-lora-precision-2GPU-epoch0.85-gate0.6-default0.5-2reward/ours_outputs.json